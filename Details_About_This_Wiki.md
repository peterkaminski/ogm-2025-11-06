...
**Participants** (13 pages):
Each participant has a dedicated page with their check-in, chat contributions, and connections to themes.

**Chat Threads** (4 pages):
Major conversation threads from the chat, synthesized with all contributors.

**Themes & Concepts** (60+ pages):
Background and context on every significant topic mentioned, from AI bias to sourdough metaphors.
...
- Click any `[[Link]]` to jump to that page
- Every page links back to README
...
- `Scott Moehring.md` (not `scott-moehring.md`)
- `AI Financial Bubble.md` (not `ai-financial-bubble.md`)
- `GABA and Filtering.md` (preserves acronym capitalization)
...
1. Read **[[README]]** for overview and highlights
2. Browse **[[Concept Index]]** to see scope
3. Pick a participant or topic that interests you
4. Follow `[[Links]]` as curiosity leads
...
1. Start with [[Jerry Michalski]]
2. Read [[Non-Local Consciousness]]
3. Follow to [[GABA and Filtering]]
4. Then [[Psilocybin and Perception]]
5. Explore [[Noetic Science]]
6. See how [[Sunil Malhotra]] and [[Dan Brown]] connect

### Exploring Connections

Example: **Environmental Neurodiversity** theme:
1. [[Doug Breitbart]] → [[Tab Groups Discovery]] → [[Executive Function and ADD]]
2. [[Scott Moehring]] → [[Environmental Neurodiversity]] → [[Curiosity and Attention]]
3. [[Mike Nelson]] → [[Overstimulation and Environmental Neurodiversity]] → [[Information Overload]]
4. See how they all connect!
...
### Plain Text Editor
- Works fine! Just search for `[[` to find links
- Grep for topics across files
...
To add new pages:
1. Create `Page Name.md` file (proper capitalization, spaces OK)
2. Add disclaimers if not from call
3. Use `[[Links]]` to connect
4. Add back link to [[README]]
5. Update [[Concept Index]] if major addition
...
**Date**: November 6, 2025 (same day as call)
**For**: Peter Kaminski and the OGM community
**Based on**: OGM 2025-11-06 call transcript and chat
**Initial analysis**: Google Gemini (participant insights)
